...
export const LIQUID_FILTER_METAS: LiquidFilterMeta[] = [
  { name: 'abs' },
  { name: 'append', insertText: 'append: "${1:value}"', snippet: true },
  { name: 'capitalize' },
  { name: 'ceil' },
  { name: 'concat', insertText: 'concat: ${1:array}', snippet: true },
  { name: 'date', insertText: 'date: "${1:%Y-%m-%d}"', snippet: true },
  { name: 'default', insertText: 'default: ${1:fallback}', snippet: true },
  {
    name: 'divided_by',
  ...
  { name: 'last' },
  { name: 'minus', insertText: 'minus: ${1:value}', snippet: true },
  { name: 'modulo', insertText: 'modulo: ${1:value}', snippet: true },
  { name: 'plus', insertText: 'plus: ${1:value}', snippet: true },
  { name: 'prepend', insertText: 'prepend: "${1:value}"', snippet: true },
  {
    name: 'replace',
  ...
  { name: 'reverse' },
  { name: 'round', insertText: 'round: ${1:decimal_places}', snippet: true },
  { name: 'size' },
  {
    name: 'slice',
  ...
  { name: 'sort' },
  { name: 'split', insertText: 'split: "${1:,}"', snippet: true },
  { name: 'strip' },
  { name: 'times', insertText: 'times: ${1:factor}', snippet: true },
  { name: 'truncate', insertText: 'truncate: ${1:100}', snippet: true },
  { name: 'uniq' },
  { name: 'upcase' },
  { name: 'sumArray', insertText: 'sumArray: "${1:key}"', snippet: true },
  {
    name: 'toCurrency',
