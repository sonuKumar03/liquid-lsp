...
- **Example:** Typing `{{ description | truncate: ` displays:
  ...
  ```
  _Documentation:_ `Truncates a string down to the number of characters passed as the first parameter. An optional second parameter can be passed to append to the truncated string.`
